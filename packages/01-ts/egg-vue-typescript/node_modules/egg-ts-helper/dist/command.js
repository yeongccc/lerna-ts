...
class Commander {
    ...
    execute() {
        ...
        const tsHelperConfig = Object.assign({ cwd: program.cwd || _1.defaultConfig.cwd, framework: program.framework, watch: watchFiles, generatorConfig, configFile: program.config }, (program.extra ? JSON.parse(program.extra) : {}));
        // silent
        if (program.silent) {
